...
//                    log.error("succesfull")
//                    saveImageToAlbum(image: image, albumName: "Ravens", completion: { success, error in
//                        if success {
...
//        
//        log.error("path: \(url.lastPathComponent)")
//        
