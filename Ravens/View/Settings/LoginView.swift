...
//              }
            ...
            .textFieldStyle(.roundedBorder)
                    ...
                    TextField("Name", text: $myInlogName)
                      .onChange(of: myInlogName) { newValue in
                        let lowercasedName = newValue.lowercased()
                        if lowercasedName != keyChainviewModel.loginName {
                          keyChainviewModel.loginName = lowercasedName
                        }
                      }
                    ...
                    SecureField("Password", text: $myPassword)
                      .onChange(of: myPassword) { newValue in
                        keyChainviewModel.password = newValue
                      }
                      .padding(4)
...
//TextField(text: $myInlogName, prompt: Text("email")) {
//  Text("emailadres")
//}
//
//SecureField(text: $myPassword, prompt: Text("password")) {
