...
//
//  var body: some View {
//      Map("Main Map", region: $region) { map in
//          ForEach([LocationXX(coordinate: CLLocationCoordinate2D(latitude: latitude, longitude: longitude))]) { location in
//              map.annotation(location.coordinate) {
//                  Circle()
//                      .fill(Color.blue)
//                      .frame(width: 10, height: 10) // Tiny blue circle
//              }
//          }
//      }
//  }
