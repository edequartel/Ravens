...
//        }
//        .onAppear {
//            fetchRequestManager.fetchDataAfterDelay(for: obsID, by: obsViewModel, completion: { log.info("obsdetailsView completed")})
//        }
//    }
//    
//}
...
//
////#Preview {
////    ObsDetailsView(obsID: 2, observationSpecies: <#T##ObservationSpecies#>,  showUsername: true)
